...
export default function HeroSection() {
	...
	return (
		...
		>
			...
			<h1 className='bg-clip-text bg-gradient-to-br from-30% from-black dark:from-white to-black/40 dark:to-white/40 opacity-0 py-6 font-medium text-4xl text-balance text-transparent sm:text-6xl md:text-7xl lg:text-8xl leading-none tracking-tighter translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]'>
			Revolutionizing Hotel 
				<br className='md:block hidden' /> Bookings with Blockchain
			</h1>
			...
			DwellChain is a decentralized application (dApp) that allows you to securely book rooms on
				<br className='md:block hidden' /> on a  blockchain.
			</p>
