...
// 							</div>
// 							<div className='z-10 flex flex-col items-center mt-4 text-center text-black'>
...
export default function HotelCardStream() {
  const allHotels = [...hotelData, ...hotelData, ...hotelData] // Tripling the array for infinite scroll

  return (
    <div className="w-full overflow-hidden bg-background p-4 space-y-8">
      {/* Stream 1: Left to Right */}
      <div className="flex animate-scroll-left hover:paused">
        {allHotels.map((hotel, index) => (
          <div key={index} className="flex-none w-full  sm:w-64 md:w-60 lg:w-96 mr-4 card-container">
            <Card className="w-full max-w-sm overflow-hidden rounded-xl shadow-lg transition-all hover:shadow-xl">
              <div className="relative">
                ...
                <span className="absolute bottom-2 left-2 bg-primary/80 text-primary-foreground">
      ...
      <div className="flex animate-scroll-right hover:paused">
        {allHotels.map((hotel, index) => (
          <div key={index} className="flex-none w-72 sm:w-64 md:w-60 lg:w-96 mr-4 card-container">
            <Card className="w-full max-w-sm overflow-hidden rounded-xl shadow-lg transition-all hover:shadow-xl">
              <div className="relative">
                <Image
                  src={img}
      ...
      <style jsx>{`
        ...
        @keyframes scroll-horizontal-left {
          ...
          100% {
            transform: translateX(calc(-25% * ${hotelData.length}));
          }
        }
        ...
        .card-container:hover ~ .animate-scroll-left,
        .card-container:hover ~ .animate-scroll-right {
